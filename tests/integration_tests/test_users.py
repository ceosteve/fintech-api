...
def test_update_user(authorised_client, test_user):
    update_data = {
        "first_name": "Steve",
        "last_name": "Njoroge",
        "email": "stevenjoro22@gmail.com",
        "birthday": "2010-03-29",
        "gender": "Male", 
        "password":"password123"
  }
    result = authorised_client.put(f"/users/update/{test_user['public_id']}", json=update_data)
